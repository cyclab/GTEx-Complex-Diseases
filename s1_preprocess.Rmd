---
title: "GTEx v6 data preprocessing"
author: "Chi-Lam Poon"
...
eset <- load(file.path(main_dir, "data/gtex_sub.rdata"))
pheno <- read.delim(file.path(main_dir, "data/pheno/p1.c1.GTEx_Subject_Phenotypes.GRU.txt"), comment.char = "#")
```
...
pc_file <- read.delim(file.path(main_dir, "data/pheno/GTEx_Analysis_2015-01-12_OMNI_2.5M_5M_450Indiv_PostImput_20genotPCs.txt"))
...
# Save
save(filtedSet, file=file.path(main_dir, "data/filted.cevd.rdata"))
```
