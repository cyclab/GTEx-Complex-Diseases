...
do
  mkdir $RESDIER/$DATA
  for t in Adipose_Visceral_Omentum Artery_Tibial Brain_Caudate_basal_ganglia Brain_Spinal_cord_cervical_c-1 Brain_Hypothalamus Brain_Putamen_basal_ganglia Whole_Blood
  do
