...
ggplot(data=long, aes(x=tissue, y=value, fill=variable)) +
  ...
  scale_y_continuous(limits=c(0, 600), expand = c(0.02, 0)) +
  #geom_text(aes(label=count), vjust=0.25, hjust=-0.3, size=2.7) +
  labs(title="", x="", y="", fill="MHCVD") +  scale_fill_manual(labels = c("up-regulated", "down-regulated"),values=c('#2d93af','#8fd7e2')) +
